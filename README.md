...
- **Required Packages**: `moderncv`, `inputenc`, `geometry`, `enumitem`
...
- `exports/CJ-Nowacek-Pipeline-Resume.pdf`
...
│   ├── CJ-Nowacek-Pipeline-Resume.pdf
│   └── CJ-Nowacek-TechArt-Resume.pdf
├── profile_toggle.tex           # Auto-generated by Makefile (gitignored)
├── .github/workflows/build.yml  # CI: builds both PDFs on push/PR
